...
TRIGGER:
  ...
  - User có thể từ chối (nếu đã archive thủ công).
```

**Lý do**: OpenSpec archive và knowledge-layer archive là 2 hệ thống riêng.
L2 đảm bảo cả 2 đều được cập nhật đồng bộ sau mỗi change hoàn thành.
