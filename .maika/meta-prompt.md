...
- Mọi SKILL.md tuân theo **Hybrid Schema SP2** (§15 trong rules-knowledge.md) — validate bằng `python3 .maika/tools/skill-lint/validate_skills.py` (source repo framework, không scaffold sang downstream).
